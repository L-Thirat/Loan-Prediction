...
delete_columns = ["OWN_BR", "KBNK_EMPE_ID", "PHOTO_F", "COLL_RSN_CODE", "BOT_IDY_CL_ID", "ORIG_BR_NBR", "PRJ_ID", "Month"]

date_columns = ["EFF_DT", "END_DT", "BRTH_DT", "ESTB_DT", "EFF_CST_DT", "BLC_DT", "ALT_BLC_CODE_DT", "OPN_DT", "MAT_DT", "LAST_PRCH_DT", "LAST_ADV_DT", "LAST_CASH_PYMT_DT", "LAST_RTL_PYMT_DT", "PYMT_DUE_DT", "LAST_MNT_DT", "NPL_DT"]
